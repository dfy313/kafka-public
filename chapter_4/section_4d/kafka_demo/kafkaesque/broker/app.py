...
def create_app(zk) -> Flask:
    ...
    def replica_fetch():
        ...
        for partition_tuple, leader_leo in list(log_end_offsets.items()):
            ...
            if partition_assignments_cache[partition_tuple]["leader_alias"] != util.BROKER_NAME:
            ...
            if partition_tuple[0] == "__consumer_offsets": continue # Only handle ISR / HW for data topics
