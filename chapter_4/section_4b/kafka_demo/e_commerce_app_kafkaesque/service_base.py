...
from kafkaesque import KafkaesqueProducer, KafkaesqueConsumer
from kafkaesque.structs import TopicPartition, OffsetAndMetadata
import pymysql
...
def create_kafkaesque_consumer(group_id, subscriptions, service_name):
    consumer = KafkaesqueConsumer(
        bootstrap_servers=KAFKA_BOOTSTRAP,
        group_id=group_id,
        client_id=CLIENT_ID,
